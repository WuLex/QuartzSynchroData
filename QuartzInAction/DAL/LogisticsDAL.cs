...
namespace QuartzInAction.SqlServerDAL
{
    ...
    public class LogisticsDAL
    {
        ...
        /// <returns></returns>
        public IList<QuartzInAction.Model.LogisticsModel> GetEntities(string sql, string _conStr,
        ...
        /// </summary>
        /// <returns></returns>
        public System.Collections.Generic.IList<QuartzInAction.Model.LogisticsModel> GetEntities(string nu,
            string _conStr)
        {
